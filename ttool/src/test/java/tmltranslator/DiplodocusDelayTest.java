...
public class DiplodocusDelayTest extends AbstractUITest {
    ...
    final int [] NB_Of_FPGA_STATES = {24, 24, 24, 24, 24, 24};
    final int [] NB_Of_FPGA_TRANSTIONS = {23, 23, 23, 23, 23, 23};
    final int [] MIN_FPGA_CYCLES = {87, 80, 74, 72, 72, 73};
    final int [] MAX_FPGA_CYCLES = {87, 80, 74, 72, 72, 73};
